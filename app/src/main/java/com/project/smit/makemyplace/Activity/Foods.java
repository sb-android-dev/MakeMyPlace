...
public class Foods extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.getMenu().findItem(R.id.nav_foods).setChecked(true);
        ...
        detector = new ConnectionDetector(Foods.this);
        sessionManager = new UserSessionManager(Foods.this);
        ...
        srlFoods = (SwipeRefreshLayout)findViewById(R.id.srlFoods);
        srlFoods.setColorSchemeResources(R.color.colorPrimary);

        srlFoods.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                if(detector.isConnectingToInternet()){
                    getData();
                }else{
                    srlFoods.setRefreshing(false);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.rvDining);
    ...
    private void getData() {
        final ProgressDialog progressDialog = new ProgressDialog(Foods.this);
        progressDialog.setMessage("Please wait...");
        progressDialog.setCancelable(false);
        progressDialog.show();
        srlFoods.setRefreshing(false);
        ApiInterface apiInterface = ApiClient.getApiClient().create(ApiInterface.class);
        Call<RetrieveClass> call = apiInterface.retrieveImage("foods");
        ...
        call.enqueue(new Callback<RetrieveClass>() {
            ...
            public void onResponse(Call<RetrieveClass> call, retrofit2.Response<RetrieveClass> response) {
                ...
                recycleAdapter = new RecyclerViewAdapter(responseList,Foods.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if(newList.isEmpty()){
                    Toast.makeText(Foods.this,"Sorry no data found!",Toast.LENGTH_SHORT).show();
                }
                return true;
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.nav_profile:
                Intent p = new Intent(Foods.this, Profile.class);
                startActivity(p);
                finish();
                break;
            case R.id.nav_hostel:
                Intent h = new Intent(Foods.this, Hostel.class);
                startActivity(h);
                finish();
                break;
            case R.id.nav_college:
                Intent c = new Intent(Foods.this,College.class);
                startActivity(c);
                finish();
                break;
            case R.id.nav_foods:
            ...
            case R.id.nav_feedback:
                Intent f = new Intent(Foods.this,Feedback.class);
                startActivity(f);
                finish();
                break;
            case R.id.nav_share:
                ...
                break;
            case R.id.nav_about:
                Intent a = new Intent(Foods.this,About.class);
                startActivity(a);
                finish();
                break;
            case R.id.nav_logout:
                logoutDialog = new Dialog(Foods.this,R.style.DialogNoActionBar);
                ...
                yes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        //startActivity(new Intent(Foods.this,Login.class));
                        finish();
                    }
                });
...
//        @Override
//        public void run() {
//            Foods.this.runOnUiThread(new Runnable() {
//                @Override
//                public void run() {
